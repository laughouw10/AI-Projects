...
grader.add_basic_part('3a', test3a0, max_points=10, max_seconds=1, description="basic test")
...
# TODO: training error descent, validation error decent but ascend in the end
############################################################
...
def test4a2():
    ...
    featureExtractor = submission.extractWordFeatures
    weights = submission.learnPredictor(trainExamples, validationExamples, featureExtractor, numEpochs=38, alpha=0.01)
...
grader.add_basic_part('4a-2', test4a2, max_points=30, max_seconds=16, description="test classifier on real polarity dev dataset")
...
grader.add_basic_part('5b', test5b0, max_points=20, max_seconds=1, description="test basic character n-gram features")
